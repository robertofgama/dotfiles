...
-- Navegação entre as Janelas com hjkl

vim.keymap.set("n", "<leader>h", "<C-w><C-h>", { desc = "Move o foco para a janela da esquerda" })
vim.keymap.set("n", "<leader>j", "<C-w><C-j>", { desc = "Move o foco para a janela de baixo" })
vim.keymap.set("n", "<leader>k", "<C-w><C-k>", { desc = "Move o foco para a janela de cima" })
vim.keymap.set("n", "<leader>l", "<C-w><C-l>", { desc = "Move o foco para a janela da direita" })
