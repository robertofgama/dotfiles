...
return {
	...
	},
	{
		...
		config = function()
			...
			require('luasnip.loaders.from_vscode').lazy_load { paths = { '~/.config/snippets/pessoais/' } }
			...
			vim.keymap.set('i', '<C-j>', function() require('cmp').complete() end,
				{ desc = 'LSP: Disparar sugestões de completação (@LspConfig)' })
		end,
	},
	{
		'hrsh7th/cmp-path',
